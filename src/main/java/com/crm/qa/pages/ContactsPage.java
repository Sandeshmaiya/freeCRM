...
public class ContactsPage extends TestBase {
	...
	public boolean contactsBannerVerify() {
		return contactsbanner.isDisplayed();
	}
	...
	public void createNewContact(String title, String frname, String lsname,String cmpy) {
